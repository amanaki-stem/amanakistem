...
from asa.education.utils import get_holidays
from asa.education.doctype.student_attendance.student_attendance import \
    get_holiday_list
...
def execute(filters=None):
	...
	for stud in students:
		...
		student_status = frappe.db.get_value("Student", stud.student, "active")
		date = from_date
		total_p = total_a = 0.0
